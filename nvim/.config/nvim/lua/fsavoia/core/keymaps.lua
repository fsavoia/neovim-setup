...
keymap.set("n", "<leader>00", "<C-w>=<CR>", { desc = "Resize window back to default" }) -- resize window back to default
...
-- Remap <C-w> to <A-BS> in insert mode (delete with option + backspace)
